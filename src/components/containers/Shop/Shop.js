    ...
    return (
        <div className={'Shop'}>
                ...
                >
                    <div className={'modal'}>
                        ...
                        <div className="modal__content">
                            ...
                            <p>Is bought ?  {changeStatus ? 'Yes' : 'No'}</p>
            ...
            <div className="Shop__root">
                ...
                <div className="Shop__root_search">
                    <Input placeholder={'search by name'} onChange={e => setTerm(e.target.value)}/>
                </div>
            </div>
            ...
            <div className="Shop__content">
                {props.shop.length !== 0 ?
                    <Table
                        dataSource={props.shop.filter(searchHandler(term))}
                        columns={columns}
